...
def main():
    ...
    heart_rate = st.text_input("Average heart rate during exercise (75-110)")
    body_temp = st.text_input("Average body temperature in centigrade during exercise(35-41)")
